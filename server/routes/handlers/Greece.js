/**
 * Greece-specific handler for direct onboarding
 */
...
class GreeceHandler extends BaseHandler {
  constructor() {
    super('GR');
  ...
  /**
   * Handle company business type for Greece
   */
