...
const DIRECTOR_EXECUTIVE_COUNTRIES: string[] = []; // USA doesn't require directors/executives
const IBAN_COUNTRIES: string[] = []; // USA uses routing numbers, not IBAN
const DEFAULT_COUNTRY = 'US';

// DirectOnboardFormData and DirectOnboardFormProps are imported from types.ts

const USAForm: React.FC<DirectOnboardFormProps> = ({
    accountId,
    email,
    businessType,
    country,
