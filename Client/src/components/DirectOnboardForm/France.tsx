...
const DIRECTOR_EXECUTIVE_COUNTRIES: string[] = ['FR']; // France requires directors/executives
const IBAN_COUNTRIES: string[] = ['FR']; // France uses IBAN
const DEFAULT_COUNTRY = 'FR';

// DirectOnboardFormData and DirectOnboardFormProps are imported from types.ts

const FranceForm: React.FC<DirectOnboardFormProps> = ({
    accountId,
    email,
    businessType,
    country,
