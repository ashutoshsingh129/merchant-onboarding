...
const DIRECTOR_EXECUTIVE_COUNTRIES: string[] = ['GB']; // UK requires directors/executives
const IBAN_COUNTRIES: string[] = []; // UK uses sort code and account number, not IBAN
const DEFAULT_COUNTRY = 'GB';

// DirectOnboardFormData and DirectOnboardFormProps are imported from types.ts

const UKForm: React.FC<DirectOnboardFormProps> = ({
    accountId,
    email,
    businessType,
    country,
    ...
    const requiresCompanyRegistrationNumber =
    ...
    const handleInputChange = (field: keyof DirectOnboardFormData, value: any) => {
        setFormData(prev => {
            ...
            // Normalize IBAN for IBAN countries: strip spaces and uppercase
            if (
            ...
            // For UK sort code: strip spaces and ensure 6 digits
            if (
                field === 'external_account_routing_number' &&
                (prev.external_account_country === 'GB' || prev.company_address_country === 'GB')
            ) {
                next.external_account_routing_number = String(value).replace(/\s+/g, '');
            }
        ...
        setFormData(prev => ({
            ...
            directors: [
                ...(prev.directors || []),
                {
                    ...
                    address_state: '',
                    address_postal_code: '',
                    address_country: prev.company_address_country || 'GB',
                    relationship_title: '',
                    id_number: '',
                    ssn_last_4: '',
                },
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // For UK (GB), require account number confirmation match
            if (formData.external_account_country === 'GB' && !isIbanCountry) {
                const accountNumber = (formData.external_account_account_number || '').trim();
                const accountNumberConfirm = (
            ...
            // Handle individual ID number based on country
            if (formData.individual_address_country === 'GB') {
                // UK: Only send National Insurance Number (id_number), no SSN fields
            ...
            } else if (formData.individual_address_country === 'US') {
                // US: Handle SSN based on toggle state
                ...
                // Other countries: Send id_number if provided
                if (formData.individual_id_number) {
                    payload.individual_id_number = formData.individual_id_number;
                }
                delete payload.individual_ssn_last_4;
            ...
            if (
                ...
                // Handle representative ID number based on country
                if (formData.representative_address_country === 'GB') {
                    // UK: Only send National Insurance Number (id_number), no SSN fields
                ...
                } else if (formData.representative_address_country === 'US') {
                    // US: Handle SSN based on toggle state
                ...
                // Handle owner ID number based on country
                if (formData.owner_address_country === 'GB') {
                    // UK: Only send National Insurance Number (id_number), no SSN fields
                    if (formData.owner_id_number) {
                        payload.owner_id_number = formData.owner_id_number;
                    }
                    delete payload.owner_ssn_last_4;
                } else if (formData.owner_address_country === 'US') {
                    // US: Handle SSN based on toggle state
                        ...
                        <Grid container spacing={3}>
                            ...
                            {formData.business_type === 'individual' && (
                                <>
                                    ...
                                    <Grid size={{ xs: 12 }}>
                                        {formData.individual_address_country === 'GB' ? (
                                            <TextField
                                                fullWidth
                                                ...
                                                helperText="UK National Insurance Number (format: AB123456C)"
                                            />
                                            ...
                                            <TextField
                                                ...
                                                helperText="Provide your national ID number"
                                            />
                                        )}
                                    </Grid>
                                </>
                            ...
                            {(formData.business_type === 'company' ||
                                ...
                                <>
                                    ...
                                    {/* Tax ID field - UK uses UTR, other countries use different formats */}
                                    <Grid size={{ xs: 12, sm: 6 }}>
                                        <TextField
                                            fullWidth
                                            label={
                                    ...
                                    <Grid size={{ xs: 12, sm: 6 }}>
                                        <TextField
                                            ...
                                            helperText={
                                                formData.company_address_country === 'GB'
                                                    ? 'UK VAT Registration Number (format: GB123456789)'
                                                    : 'VAT Registration Number (optional)'
                                            }
                                        />
                                    </Grid>

                                    {/* Company Registration Number (CRN) for UK */}
                                    {requiresCompanyRegistrationNumber && (
                                        <Grid size={{ xs: 12, sm: 6 }}>
                                            <TextField
                                                fullWidth
                                                ...
                                                helperText="Companies House registration number (8 digits)"
                                            />
                                        </Grid>
                                    )}
                                                ...
                                                {companyStructures
                                                    .filter(structure => {
                                                        ...
                                                        if (
                                                            ...
                                                            // For UK company, restrict to supported structures
                                                            if (
                            ...
                            {(formData.business_type === 'company' ||
                                ...
                                <>
                                    ...
                                    <Grid size={{ xs: 12 }}>
                                        {formData.representative_address_country === 'GB' ? (
                                            <TextField
                                                fullWidth
                                                label="National Insurance Number (NINO)"
                                            ...
                                            <TextField
                                                ...
                                                placeholder="National ID Number"
                                                helperText="Provide national ID number"
                                            />
                                        )}
                                    </Grid>
                            ...
                            {(formData.business_type === 'company' ||
                                ...
                                !representativeIsOwner && (
                                    <>
                                        ...
                                        <Grid size={{ xs: 12 }}>
                                            {formData.owner_address_country === 'GB' ? (
                                                <TextField
                                                    fullWidth
                                                    label="National Insurance Number (NINO)"
                            ...
                            {showExternalAccount &&
                                formData.external_account_object === 'bank_account' && (
                                    <>
                                        ...
                                        <Grid size={{ xs: 12, sm: 6 }}>
                                            <FormControl fullWidth>
                                                <InputLabel>Country of bank account</InputLabel>
                                                <Select
                                        ...
                                        {/* Sort code for UK (GB) */}
                                        {formData.external_account_country === 'GB' && (
                                            <Grid size={{ xs: 12, sm: 6 }}>
                                                <TextField
                                                    fullWidth
                                                    label="Sort code"
                                                    ...
                                                    placeholder="108800"
                                                    helperText="UK sort code (6 digits)"
                                                    inputProps={{ maxLength: 6 }}
                                                />
                                            </Grid>
                                        )}

                                        {/* Routing number for non-IBAN, non-UK countries */}
                                        {!isIbanCountry &&
                                            formData.external_account_country !== 'GB' && (
                                                <Grid size={{ xs: 12, sm: 6 }}>
                                                    <TextField
                                        ...
                                        {/* Confirm IBAN for IBAN countries */}
                                        {isIbanCountry && (
                                            <Grid size={{ xs: 12, sm: 6 }}>
                                                <TextField
                                                    fullWidth
                                        ...
                                        {/* Confirm account number for UK (GB) */}
                                        {formData.external_account_country === 'GB' &&
                                            !isIbanCountry && (
                                                <Grid size={{ xs: 12, sm: 6 }}>
                                                    <TextField
                                                        ...
                                                        helperText="Re-enter account number to confirm"
                                                    />
                                                </Grid>
                                            )}
